...
export function Footer() {
  return (
    <section className="relative overflow-hidden bg-[#0a0e19] py-8">
        ...
        <div className="-m-8 flex flex-wrap items-center justify-between">
          ...
          <div className="w-auto p-8">
            <ul className="-m-5 flex flex-wrap items-center">
              <li className="p-5">
                <Link className="font-medium text-gray-300 hover:text-gray-500" to={'/contact-us'}>
                  Contact-Us
                </Link>
              </li>
              <li className="p-5">
                <Link className="font-medium text-gray-300 hover:text-gray-500" to={'/how-to-use'}>
                  How to Use?
                </Link>
              </li>
              <li className="p-5">
                <a className="font-medium text-gray-300 hover:text-gray-500" href="#">
                  Disclaimer
                </a>
              </li>
              {/* <li className="p-5">
