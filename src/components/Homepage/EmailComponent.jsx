...
export const EmailComponent = () => {
    ...
    Take care!`
    return (
        <div className='relative file:flex flex-col rounded-3xl bg-slate-200 gap-3 w-[30%] mx-auto p-3 z-[10] shadow-custom'>
            ...
            <div className=' px-4 py-2 flex gap-4 '>
                <span className=' text-gray-400 font-semibold'>From:</span> <img src={profile} alt='email pic' width={30} height={20} /> <p>sandeep@devcom.tech</p>
            </div>
            <div className='h-[0.5px] bg-slate-300 w-[95%] mx-auto'></div>
            <div className=' px-4 py-2 flex gap-4 justify-between'>
                <p className=' text-black font-semibold'>Bulk E-mail Sender</p> <span className=' rounded-3xl bg-slate-300 px-2'>80</span>
            </div>
            <div className='h-[0.5px] bg-slate-300 w-[95%] mx-auto'></div>

            {/* auto write email */}
            <div className='h-[200px] p-3 text-gray-500'>
                <TypeAnimation
